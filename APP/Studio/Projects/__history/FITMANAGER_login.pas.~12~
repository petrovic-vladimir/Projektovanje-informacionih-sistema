...
uses
  ...
  FMX.Ani, FMX.Edit,
  FITMANAGER_register, FITMANAGER_dashboard,
  DB;
...
begin
  // TODO: replace with your admin unit + form name
  // Example:
  ...
  ShowMessage('AdminPage form not linked yet.');
end;

procedure TFrmLogin.OpenTrainerPage;
begin
  // TODO: replace with your trainer unit + form name
  // Example:
  ...
  ShowMessage('TrainerPage form not linked yet.');
end;
...
begin
  ...
  begin
    case dmDB.CurrentRole of
      ...
      ShowMessage('Korisnik nema dodeljenu ulogu (Admin/Member/Instructor).');
    end;
  end
  else
